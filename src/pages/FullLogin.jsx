...
//              className=" w-full bg-[#ff0084] border-0  text-lg font-semibold py-2 mt-5 rounded-lg text-white focus:outline-none focus:shadow-outline disabled:opacity-50"
//           >
//             Log in
//           </button>
//         </div>
...
//    {/* <Link to={'/signup'} className="text-lg text-[#9a9a9a] cursor-pointer   "> Not Register Yet?</Link>
//    <Link to={'/signup'} className="text-xl font-bold text-[#409047] cursor-pointer   "> Create New Account </Link> */}
