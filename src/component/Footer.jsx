...
const Footer = () => {
  return (
    ...
    <footer className=" bg-[#fcfcfc] fixed bottom-0 w-full h-[67px] py-2 px-6 flex items-center justify-between shadow-2xl rounded-tl-3xl rounded-tr-3xl ">
  ...
  <FaGift className=' text-xl sm:text-3xl text-[#808085] '/>
     <span className="text-[#01cfff] text-[12px] "> কাজ  </span>
  </Link>
